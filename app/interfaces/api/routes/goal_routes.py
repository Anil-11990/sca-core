...
# Schemas
from app.interfaces.api.schemas.goal_request import (
    GoalRequest,
)

from app.interfaces.api.schemas.goal_response import (
    GoalResponse,
)


# Mapper
from app.interfaces.api.mappers.goal_mapper import (
    to_goal_response,
)
