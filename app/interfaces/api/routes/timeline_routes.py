...
from app.interfaces.api.schemas.timeline_event_request import (
    TimelineEventRequest,
)

from app.interfaces.api.schemas.timeline_event_response import (
    TimelineEventResponse,
)


from app.interfaces.api.mappers.timeline_event_mapper import (
    TimelineEventMapper,
)
...
def add_timeline_event(
    ...
    use_case = (
        container.add_timeline_event_use_case()
    )
...
def get_timeline_events(
    ...
    use_case = (
        container.get_timeline_events_use_case()
    )
...
def remove_timeline_event(
    ...
    use_case = (
        container.remove_timeline_event_use_case()
    )
